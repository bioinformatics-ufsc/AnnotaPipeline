...
parser = argparse.ArgumentParser(
    add_help=False,
    description='''
    AnnotaPipeline_after_blast
    
    If you are here, I assume you're already ran blastp_parser_afterblast.
    All you have to do is put this script and
    funcannotaion_parser.py
    gfftofasta.py
    in the same path were your blast results are in.
    
    Don't forget that AnnotaPipeline.config must be there as well.
