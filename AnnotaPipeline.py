...
### Nota da Versão do Diretor: Se o indivíduo for rodar o Augustus em mais de um genoma
### precisamos criar um loop para fazer esta etapa múltiplas vezes (=número de genomas)
### e, depois, vamos precisar executar o CD-Hit também.
...
aug_parsing = "AUGUSTUS_" + str(AnnotaBasename)
...
subprocess.run([
    ...
    "-gff",
    str(augustus_folder / str("AUGUSTUS_" + str(AnnotaBasename) + ".gff")),
    "-annot",
